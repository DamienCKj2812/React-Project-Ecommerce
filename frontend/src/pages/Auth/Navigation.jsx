...
import { AiOutlineHome, AiOutlineShopping, AiOutlineLogin, AiOutlineUserAdd, AiOutlineShoppingCart, AiOutlineHeart, AiOutlineUser } from 'react-icons/ai';
...
const toggleDropdown = () => {
    // If false then it becomes true, if true then it becomes false
...
return (
    <div 
        style={{zIndex: 999}}  // This component is top of everthing
    ...
    > 
        ...
        <div className="relative">
            ...
            >
                ...
                {userInfo ? ( //Showing the username at the side
                    <span className="text-white">{userInfo.username}</span>
                ) : (
                    <></>
                )}

                {userInfo && (  //Icon of dropdown arrow
                    <svg
            ...
            >
                ...
                )} {/*if user is not admin it will only show profile and logout*/}
                <li>
