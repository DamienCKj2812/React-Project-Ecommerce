                        ...
                        <div className="flex items-center justify-between w-[20rem]">
                            ...
                            <div className="two">
                                ...
                                <h1 className="flex items-center mb-6 w-[10rem]">
                                    <FaStar className="mr-2"/> In Stock: {" "}{product.countInStock}
                                </h1>
                            </div>
                        </div>
                        ...
                        <div className="flex justify-between flex-wrap">
                            ...
                            {product.countInStock > 0 && (
                                <div>
                                    ...
                                    >
                                        {[...Array(product.countInStock).keys()].map(x => ( //For each number x, it creates an <option> element with a unique key
